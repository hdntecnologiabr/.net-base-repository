...
using Hdn.Core.Architecture.Application.Enums;
using Hdn.Core.Architecture.Application.Exceptions;
using Hdn.Core.Architecture.Application.Interfaces.Services;
using Hdn.Core.Architecture.Application.Wrappers;
using Hdn.Core.Architecture.Domain.Settings;
...
namespace Hdn.Core.Architecture.Infrastructure.Identity.Services
{
        ...
        public async Task<Response<string>> RegisterAsync(RegisterRequest request, string origin)
        {
            ...
            if (userWithSameEmail == null)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    return new Response<string>(user.Id, message: $"Usuário Criado");
                }
                else
                {
